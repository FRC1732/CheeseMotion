package frc.robot.examplepaths.profiles;

import java.util.ArrayList;

import frc.robot.examplepaths.PathBuilder;
import frc.robot.examplepaths.PathBuilder.Waypoint;
 ...
 * 
 * Will need to make one of these every year as the field changes
 * 
 * @see RobotProfile
 * @see FieldProfile
 */
public class PathAdapter {
	...
	public static RigidTransform2d getBlueStartPose() {
		return new RigidTransform2d(
				new Translation2d(Constants.kCenterToFrontBumperDistance, kFieldHeight / 2
						+ kFieldProfile.getBlueCenterToBoiler() - Constants.kCenterToSideBumperDistance),
				kStartHeading);
	}
