...
import frc.robot.auto.examplemodes.CenterGearThenShootModeBlue;
...
import frc.robot.main.SubsystemManager;
...
public class Robot extends IterativeRobot {
	...
	public void autonomousInit() {
		...
		mAutoModeExecuter.setAutoMode(new CenterGearThenShootModeBlue());
