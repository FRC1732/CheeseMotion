...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
	...
	/**
	 * Finds the point where the heading of this transform intersects the heading of
	...
	/**
	 * Return true if the heading of this transform is colinear with the heading of
	 * another.
	 */
